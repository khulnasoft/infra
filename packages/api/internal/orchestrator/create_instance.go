...
import (
	...
	"github.com/khulnasoft/infra/packages/api/internal/cache/instance"
	"github.com/khulnasoft/infra/packages/api/internal/sandbox"
...
func (o *Orchestrator) CreateSandbox(
	...
	// 		"you have reached the maximum number of concurrent KHULNASOFT sandboxes (%d). If you need more, "+
	// 			"please contact us at 'https://khulnasoft.dev/docs/getting-help'", maxInstancesPerTeam)
	// }
	//
