...
copy-public-builds:
	...
	gsutil cp -r gs://khulnasoft-prod-public-builds/kernels/* gs://$(GCP_PROJECT_ID)-fc-kernels/
	gsutil cp -r gs://khulnasoft-prod-public-builds/firecrackers/* gs://$(GCP_PROJECT_ID)-fc-versions/
